...
module.exports = {
  ...
  twitch: {
    clientID: 'TU_TWITCH_CLIENT_ID', // Make a Twitch application at
    clientSecret: 'TU_TWITCH_CLIENT_SECRET' // https://dev.twitch.tv/console/apps
  },
  discord: {
    token: 'TU_TOKEN_DE_DISCORD', // https://discordapp.com/developers/applications/me/
