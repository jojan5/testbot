...
export declare class Scripts {
    ...
    addJobScheduler(jobSchedulerId: string, nextMillis: number, opts: RepeatableOptions): Promise<string>;
    updateRepeatableJobMillis(client: RedisClient, customKey: string, nextMillis: number, legacyCustomKey: string): Promise<string>;
    updateJobSchedulerNextMillis(jobSchedulerId: string, nextMillis: number): Promise<number>;
